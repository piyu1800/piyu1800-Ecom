...
#             DictItems= {product_id:{'name':product.name, 'price':product.price, 'discount':product.discount, 'color':product.colors,'quantity':product.quantity,'image':product.image_1, 'colors':product.colors}}
